...
test('Diagnostic | Inspect Collect DTMF Properties Form HTML', async ({ page }) => {
  ...
  // Click Collect DTMF 1 node to open panel
  console.log('Clicking Collect DTMF 1...');
  const dtmfNode = page.locator('.react-flow__node:has-text("Collect DTMF 1")').first();
  await dtmfNode.click();
  ...
  console.log('--- COLLECT DTMF FORM HTML ---');
